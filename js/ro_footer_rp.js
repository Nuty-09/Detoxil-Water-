document.addEventListener('DOMContentLoaded', function(){
  ...
  setTimeout(function() {
    ...
    romFooter.insertAdjacentHTML("afterbegin", '<div class="rom-footer"><div class="rom_center"> ' +
        ...
        ' <a href="policy.html" target="_blank" class="rom_link">Politica de confidențialitate</a></div><div class="rom_center"> <p class="rom_contact rom_p"></p></div></div>');
